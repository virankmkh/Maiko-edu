...
async function setupPostgreSQLData() {
  try {
    console.log('🚀 Setting up PostgreSQL data with 5 courses and 10 students each...\n');
    ...
    // Display summary
    console.log('\n🎉 PostgreSQL data setup complete!');
    console.log('📊 Summary:');
    ...
    console.error('❌ Error setting up PostgreSQL data:', error.message);
